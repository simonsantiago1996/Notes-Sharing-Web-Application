	      ...
	      <ul class="slides">
	    	<li>
	    		...
	    		<div class="flex-caption">
                     <div class="caption_title_line"><h2>Notes Management by Simon Santiago</h2><p>Now easily manage all kind of notes by uploading them here.</p></div>
                </div>
	    	</li>
	    	<li>
	    		<a href="#"><img src="images/slider/slide2.jpg" alt="" title=""/></a>
	    		<div class="flex-caption">
                     <div class="caption_title_line"><h2>Your Various Files</h2><p>You can upload various types of files like PDF, PPT, DOC etc..</p></div>
                </div>
	    	</li>
	    	<li>
